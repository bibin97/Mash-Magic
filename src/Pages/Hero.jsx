...
export default function Home() {
  ...
  return (
    <main
      className="relative py-24 px-4 sm:px-8 lg:px-12 max-w-7xl mx-auto flex flex-col-reverse 
                 lg:flex-row items-start lg:items-center justify-between gap-10 overflow-hidden"
    >
      {/* Background Gradient */}
      ...
      <Animatedsection className="w-full lg:w-1/2 flex flex-col items-center">
        <div className="relative w-full max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl rounded-3xl overflow-hidden shadow-2xl">
          <div className="aspect-[4/3] sm:aspect-[5/3] md:aspect-[16/9] lg:h-[450px] w-full">
