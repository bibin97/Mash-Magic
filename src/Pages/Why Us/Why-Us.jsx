       ...
       h1
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-12 mb-10 w-full">
          <div className="flex flex-col items-center text-center flex-1">
            ...
            <h3 className="font-bold text-lg text-teal-800 mb-1">Book Free Demo</h3>
            <p className="text-gray-600 text-sm">Reserve a session for your child, absolutely free.</p>
          </div>
          <div className="flex flex-col items-center text-center flex-1">
            <div className="bg-teal-100 p-4 rounded-full mb-3 shadow-sm">
              <ClipboardCheck className="w-10 h-10 text-teal-600" />
            </div>
            <h3 className="font-bold text-lg text-teal-800 mb-1">Personalized Assessment</h3>
            <p className="text-gray-600 text-sm">Get a tailored learning plan based on strengths and needs.</p>
          </div>
          <div className="flex flex-col items-center text-center flex-1">
            <div className="bg-green-100 p-4 rounded-full mb-3 shadow-sm">
              <Rocket className="w-10 h-10 text-green-500" />
            </div>
            <h3 className="font-bold text-lg text-teal-800 mb-1">Start Learning Journey</h3>
            <p className="text-gray-600 text-sm">Begin your child’s transformation with Mash Magic mentorship.</p>
          </div>
        </div>
        <a
          href="#demo"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-8">
          <div className="bg-[#fafbfc] border border-gray-200 rounded-xl p-0 flex flex-col items-center min-h-[420px] max-w-[380px] mx-auto md:mx-0 overflow-hidden">
            <div className="w-full h-[260px]">
              <ImageCarousel slides={[{ img: card1 }, { img: card11 }]} height="100%" />
            </div>
          ...
          <div className="bg-[#fafbfc] border border-gray-200 rounded-xl p-0 flex flex-col items-center min-h-[440px] max-w-[380px] mx-auto md:mx-0 overflow-hidden">
            <div className="w-full h-[280px]">
              <ImageCarousel slides={[{ img: card2 }, { img: card22 }]} height="100%" />
            </div>
            <div className="w-full px-10 pt-8 pb-8 flex flex-col items-center">
              <h3 className="text-xl font-bold text-black-800 mb-3 text-center">
          ...
          <div className="bg-[#fafbfc] border border-gray-200 rounded-xl p-0 flex flex-col items-center min-h-[440px] max-w-[380px] mx-auto md:mx-0 overflow-hidden">
            <div className="w-full h-[280px]">
              <ImageCarousel slides={[{ img: card3 }, { img: card33 }]} height="100%" />
            </div>
            <div className="w-full px-10 pt-8 pb-8 flex flex-col items-center">
          ...
          <p className="font-extrabold text-black text-2xl font rounded text-center col-span-full">
            It’s not your child’s weakness, it’s the system.
          </p>
        </div>
      </Animatedsection>

      {/* Solution Section (with See How It Works button) */}
